    ...
    constructor(config) {
        ...
        this.handler = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (secret !== getJssEditingSecret()) {
                debug.experienceEditor('invalid editing secret - sent "%s" expected "%s"', secret, getJssEditingSecret());
        ...
        this.dataFetcher =
            (_b = config === null || config === void 0 ? void 0 : config.dataFetcher) !== null && _b !== void 0 ? _b : new AxiosDataFetcher({ debugger: debug.experienceEditor });
