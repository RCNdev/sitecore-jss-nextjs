...
exports.GraphQLSitemapService = exports.languageError = exports.queryError = void 0;
...
class GraphQLSitemapService {
    ...
    constructor(options) {
        ...
        this.searchService = new sitecore_jss_1.SearchQueryService(this.graphQLClient);
    }
    /**
    ...
    fetchSitemap(languages, formatStaticPath) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const rootItemId = this.options.rootItemId ||
                (yield sitecore_jss_1.getAppRootId(this.graphQLClient, this.options.siteName, languages[0], this.options.jssAppTemplateId));
            if (!rootItemId) {
     ...
     */
    getGraphQLClient() {
        return new sitecore_jss_1.GraphQLRequestClient(this.options.endpoint, {
     ...
     */
    getSearchService() {
        return new sitecore_jss_1.SearchQueryService(this.graphQLClient);
    }
}
