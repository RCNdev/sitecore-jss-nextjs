...
exports.getJssEditingSecret = exports.handleExperienceEditorFastRefresh = exports.handleEditorFastRefresh = exports.getPublicUrl = void 0;
...
const handleEditorFastRefresh = (forceReload = false) => {
    if (process.env.NODE_ENV !== 'development' || !sitecore_jss_1.isEditorActive()) {
    ...
    eventSource.onmessage = (event) => {
        ...
        setTimeout(() => {
            ...
            sitecore_jss_1.resetEditorChromes();
        }, 500);
    };
};
 ...
 * @default forceReload false
 */
exports.handleExperienceEditorFastRefresh = exports.handleEditorFastRefresh;
